<template>
	<div>
							...
							>
								...
								<td>
									<div class="table-data-feature">
										<button
											@click="
												getPincodeByDeliveryBoy(user.id)
											"
											data-toggle="modal"
											data-target="#staticPincodeList"
		...
		<pincode-list :pincode-list="pincodeList"></pincode-list>
	</div>
</template>
<script src="./index.js" />
